var NioApp = function (i, w) {
    "use strict";
    var t = w(window), o = w("body"), s = "nio-theme", e = "lite-dash";
    ...
    return w.fn.exists = function () {
        ...
        i.Win = {height: t.height(), width: t.outerWidth()}, i.State.asMobile = i.Win.width < i.Break.md
        ...
        var a = e || ".header-menu", o = t || i.Break.md, e = {timeOut: 1e3, classAdd: "mobile-menu"},
            n = s ? r(e, s) : e, t = n.ignore || !1;
        ...
        var s = {showClass: "is-shown", hideClass: "is-hidden"}, a = t ? r(s, t) : s;
        w(e).exists() && w(e).on("click", function (e) {
            var t = w(this), s = t.data("target"), s = w("#" + s);
        ...
        var s = {prefix: "nk-", class: "", has: "has"}, t = t ? r(s, t) : s,
            s = e.replace(".", "").replace(t.prefix, ""), e = s;
        ...
        trigger: function (e, t) {
            var s = {
                    ...
                    olay: "toggle-overlay",
                    speed: 400
                }, t = t ? r(s, t) : s, s = w("[data-target=" + e + "]"), e = w("[data-" + t.data + "=" + e + "]"),
            ...
            var s = {self: e, active: "active", content: "expanded", body: "", data: "content", olay: "toggle-overlay"},
                t = t ? r(s, t) : s, s = w("[data-target=" + e + "]"), e = w("[data-" + t.data + "=" + e + "]"),
                a = e.data("toggle-body");
            ...
            var s = {active: "active", self: "link-toggle", child: "menu-sub", speed: 400}, t = t ? r(s, t) : s,
                s = w(e).parent(), e = s.children("." + t.child);
            ...
            var t = w(e).find(".nk-profile-toggle.active"), e = w(e).find(".nk-profile-content.expanded");
        ...
        var s = {boundary: "window", trigger: "hover"}, a = t ? r(s, t) : s;
        ...
        w(e).exists() && "function" == typeof w.fn.datepicker && w(e).each(function () {
            var e = w(this).data("date-format"), e = {
        ...
        var s = {startView: 2, todayHighlight: !1}, t = t ? r(s, t) : s;
        i.Picker.date(e, t)
        ...
        w(e).exists() && "function" == typeof w.fn.timepicker && w(e).each(function () {
            ...
            var e = w(this).data("time-format"), t = w(this).data("time-interval"), e = {
        ...
        var t = !(!s.dataset.stepInit || isNaN(s.dataset.stepInit)) && parseInt(s.dataset.stepInit), t = {
            selectors: {
        ...
        let a = s.querySelectorAll(`.${t.selectors.nav} > *`), o = s.querySelectorAll(`.${t.selectors.content} > *`),
            n = (s.querySelector("." + t.selectors.progress), s.querySelector(`.${t.selectors.progress}-count`)),
            i = s.querySelector(`.${t.selectors.progress}-bar`), r = s.querySelector("." + t.selectors.prev),
            l = s.querySelector("." + t.selectors.next), c = s.querySelector("." + t.selectors.submit),
            d = t.classes.nav_current, u = t.classes.nav_done, h = t.classes.step_active, p = t.classes.step_done,
            f = t.current_step || 1, v = f, m = a.length, g = o.length,
            y = 0 < s.querySelectorAll("." + t.selectors.nav).length,
            b = 0 < s.querySelectorAll("." + t.selectors.progress).length;

        function C(e) {
            var t = e - 1, t = (s.style.display = "block", y && (a.forEach(function (e, t) {
    ...
    }, o = {docReady: [], docReadyDefer: [], winLoad: [], winLoadDefer: [], onResize: [], onResizeDefer: []};
